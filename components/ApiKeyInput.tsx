    ...
    <div className="bg-[var(--color-surface)] rounded-2xl p-8 max-w-md mx-auto text-center">
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div>
          <button
            type="submit"
            className="flex justify-center mx-auto py-3 px-4 border border-transparent rounded-md text-sm font-bold bg-[var(--color-accent)] hover:bg-[var(--color-accent)]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer focus:ring-[var(--color-accent)]/60 transition-colors text-[var(--color-foreground)]"
          >
